package com.hyun.tpsearchplacebykakao.adapter
...
import com.hyun.tpsearchplacebykakao.databinding.RecyclerItemListFragmentBinding
...
class PlaceListRecyclerAdapter(val context:Context, val documents: List<Place>) : Adapter<PlaceListRecyclerAdapter.VH>() {
    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        ...
        // 아이템뷰를 클릭하였을 때 상세정보페이지 url을 보여주는 화면으로 이동
