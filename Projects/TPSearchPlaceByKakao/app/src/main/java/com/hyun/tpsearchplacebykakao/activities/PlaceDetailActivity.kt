...
import com.hyun.tpsearchplacebykakao.databinding.ActivityPlaceDetailBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.fabFavor.setOnClickListener {
            if (isFavorite){
                ...
                Toast.makeText(this, "찜목록이 제거되었습니다", Toast.LENGTH_SHORT).show()
            }else{
                // 찜 DB에 데이터를 저장
                place.apply {
                ...
                Toast.makeText(this, "찜목록이 추가되었습니다", Toast.LENGTH_SHORT).show()
            }
