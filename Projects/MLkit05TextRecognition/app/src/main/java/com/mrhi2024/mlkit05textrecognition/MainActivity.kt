package com.mrhi2024.mlkit05textrecognition
...
import com.mrhi2024.mlkit05textrecognition.databinding.ActivityMainBinding
            ...
            for( block in it.textBlocks ){
                ...
                block.lines.forEach { line ->
                    ...
                    line.elements.forEach { element ->
                        ...
                        element.boundingBox?.apply { canvas.drawRect(this, paint) }
                    }
                    binding.tv.append("\n")
                }
