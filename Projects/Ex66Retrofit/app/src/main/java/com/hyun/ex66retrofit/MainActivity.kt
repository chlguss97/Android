...
import com.hyun.ex66retrofit.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickBtn2(){
        ...
        //1. 레트로핏 객체 생성
        val builder: Retrofit.Builder = Retrofit.Builder()
        builder.baseUrl("http://mrhi2024.dothome.co.kr")
    ...
    private fun clickBtn1(){
        ...
        // retrofit library 를 이용하면..서버에서 json 문자열을 읽어와서 분석하여 Item객체로 곧바로 파싱하여 받을 수 있음.
