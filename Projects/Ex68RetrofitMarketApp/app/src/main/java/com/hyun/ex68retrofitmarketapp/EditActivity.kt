...
import com.hyun.ex68retrofitmarketapp.databinding.ActivityEditBinding
...
class EditActivity : AppCompatActivity() {
    ...
    private fun clickComplete(){
        ...
        val datapPart: MutableMap<String, String> = mutableMapOf()
        datapPart["name"]= name
        datapPart["title"]= title
        datapPart["msg"]= msg
        datapPart["price"]= price
        //다음으로 이미지파일을 MultipartBody.Part로 포장하여 전송 : @part
        ...
        //네트워크 작업 시작
        retrofitService.postDataToServer(datapPart,filePart).enqueue(object : Callback<String>{
