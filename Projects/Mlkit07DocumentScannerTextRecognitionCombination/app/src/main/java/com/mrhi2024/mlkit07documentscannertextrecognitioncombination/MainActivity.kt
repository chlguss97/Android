package com.mrhi2024.mlkit07documentscannertextrecognitioncombination
...
import com.mrhi2024.mlkit07documentscannertextrecognitioncombination.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private val scannerLauncher= registerForActivityResult(ActivityResultContracts.StartIntentSenderForResult()){
        if(it.resultCode== RESULT_OK){
            ...
            //스캔한 이미지가 있다면..그 개수만큼. uri가 존재할 것임..이를 리스트에 저장해 놓기
            result?.pages?.forEach { page->
                imageUriList.add(0,page.imageUri)
